...
// //   return (
// //     <Box sx={{ marginBottom: 2, marginTop: 3, marginLeft: 20, marginRight: 0 }}>
...
// //               {e.poster_path !== null && (
// //                 <Grid item xs={12} sm={3} md={4} lg={4} key={e.id}>
// //                   <Box
// //                     position="relative"
// //                     draggable="false"
// //                     sx={{ marginRight: 0, width: 80 }}
// //                   >
// //                     <Card
// //                       variant="outlined"
// //                       sx={(theme) => ({
...
//     getUpcommingmovie().then((res) => {
//       Setperpagemovie(res.slice(startIndex, endIndex));
//       setloader(false)
//     });
...
// const moredescriptionhandle=(id)=>{
//   console.log(id)
...
//     <Box sx={{ marginBottom: 2, marginTop: 3, marginLeft: 20, marginRight: 0 }}>
//       <Grid container spacing={1}>
//        {!Loader && perpagemovie && perpagemovie.map((e) => (
//           <>
//           {console.log(perpagemovie)}
//             {e.poster_path === null && null}
...
//                             <strong>About the movie</strong>
//                           </Typography>
//                          { !showabout &&  <Typography fontWeight="15px" level="body2">
//                             {e.overview.slice(0, 100)}{" "}
//                            <Link onClick={()=>(moredescriptionhandle(e.id))}><Typography>
